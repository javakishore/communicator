...
<body>
	...
	<div class="title-bar" style="    background-color:#E70028;margin: 0px;">
		...
		<h2 class="title" style="color:white">View Rate App List</h2>
	</div>
	<div class="clear_both">&nbsp;</div>
					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								...
								<li><a id="anchorfontcolor13" style="color:white;" class="active" href="/crmCmsAdmin/viewrating">Rate App</a></li>
								...
								<c:when test="${!empty rateList}">
									<table  class="table table-striped table-bordered table-hover dataTables-example">
										<tr>
											...
											<th width="80">Rate value</th>
											<th width="80">Date and Time</th>
										</tr>
