...
<body>
	...
	<div class="container-fluid">
		<div class="row">
					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								...
								<li><a id="anchorfontcolor8" style="color:white;" class="active" href="/crmCmsAdmin/pendingcategory">Pending Category</a></li>
			...
			<div class="col-md-10">approved Successfully</div>
