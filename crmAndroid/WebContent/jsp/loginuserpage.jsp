...
<form name="loginuser" action="loginuser" method="post">
	...
	<div class="title-bar"  style="    background-color:#E70028;margin: 0px;">
		...
		<h2 class="title" style="color:white">Log In Details</h2>
	</div>
<!-- 	<div class="clear_both">&nbsp;</div> -->
					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								...
								<li><a id="anchorfontcolor14" style="color:white;" class="active" href="/crmCmsAdmin/loginDetails">Log In Details</a></li>
									...
									<tbody>
										<c:forEach items="${messageList}" var="messageList">
											<tr class="gradeA">
												...
												<td>${messageList.username}</td>
												<td>${messageList.logindate}</td>
												<td align="left">${messageList.status}</td>
												<td>${messageList.location}</td>
