...
<body>
		...
		<div class="header-wrap">
			...
			<div class="right-block pull-right">
				...
				<div class="logout-box pull-left">
					<a class="btn btn-logout" href="/crmCmsAdmin/logout.htm">Logout</a>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								...
								<li><a id="anchorfontcolor5" style="color:white;" class="active" href="/crmCmsAdmin/pendingmessages">Pending Messages</a></li>
			...
			<div class="col-md-10">  Message approved.</div>
