					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								<!-- <li><a id="anchorfontcolor" href="/crm/addcategory">Add Category</a></li> -->
								...
								<li><a id="anchorfontcolor6" style="color:white;" class="active" href="/crmCmsAdmin/myCategory">Category List</a></li>
