...
<body>
	...
	<div class="title-bar" style="    background-color:#E70028;margin: 0px;">
		...
		<h2 class="title" style="color:white">Favorite Message List</h2>
	</div>
	<div class="clear_both">&nbsp;</div>
					...
					<c:choose>
						<c:when test="${user.userType=='admin'}">
							<ul class="main-nav" style="border:none;">
								...
								<li><a id="anchorfontcolor12" style="color:white;" class="active" href="/crmCmsAdmin/favouritemessage">Favourite</a></li>
