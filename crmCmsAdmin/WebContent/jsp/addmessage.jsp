...
<link type="text/css"
	...
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/resources/chat/assets/bootstrap-3.3.5/css/bootstrap.css"
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/resources/chat/assets/css/clientWebPage.css"
	rel="stylesheet" />
<style>
.add {
	visibility: hidden;
...
<script
	src="<%=request.getContextPath()%>/resources/chat/assets/bootstrap-3.3.5/jquery-2.1.4.js"
	type="text/javascript"></script>
<script
	src="<%=request.getContextPath()%>/resources/chat/assets/bootstrap-3.3.5/js/bootstrap.js"
	type="text/javascript"></script>
		...
		xhttp.onreadystatechange = function() {
			if (xhttp.readyState == 4 && xhttp.status == 200) {
				...
				for (var i = 0; i < str_array2.length; ++i) {
					...
					selectelement.options[i].text = selVal.substr(selVal
							.indexOf("_") + 1);
	...
	<div class="header">
		<div class="header-wrap" style="padding: 0px 0px;">
			<div class="logo pull-left">
				<a href="javascript:void(0);" title="PruBSN"> <img height="100%"
					width="100%" alt="PruBSN" src="resources/images/PruBSN_logo.png"
					style="padding-top: 1%;">
				</a>
			</div>
			<div class="right-block pull-right" style="padding: 10px 15px;">
				...
				<div class="logout-box pull-left">
					<div class="logout-box pull-left">
						<a id="login"
							style="color: #3c3434; background-color: white; border-radius: 5px; border-color: #E70028"
							class="btn btn-logout anchor3" href="/crmCmsAdmin/logout.htm">Logout</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="addCategoryform">
					...
					<div class="">
						<br />
						<form:form name="addmessage" action="addmessage" method="post"
							...
							<div class="form-group">
								...
								<div id="test" class="col-sm-5">
									...
									<c:if
										test="${user.userName=='admin' or user.userName=='superadmin'}">
										<select id="allpamb" name="allpamb" class="form-control"
											multiple="multiple">
											...
											<option selected value="17">BRANCH
												OFFICE(DIRECT)-PAMB</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<form:select path="" cssClass="form-control" id="channelId"
										name="channelId" onchange="loadCategoryfilter();">
							...
							<div class="form-group" id="div1">
								...
								<div class="col-sm-5">
									<input type="file" name="file_image" id="img1"
										value="file_image" accept='image/*' /> <img id="blah1"
										class="add" src="" alt="Image" height="100" />
								</div>
							</div>
							...
							<div class="form-group" id="div2">
								<label class="control-label col-sm-2">Image upload :</label>
								<div class="col-sm-5">
									<input type="file" name="file2_image" id="img3"
										accept='image/*' /> <img id="blah3" class="add" src=""
							...
							<div class="form-group">
								<label class="control-label col-sm-2">Effective Date &
									Time :</label>
								<div class="col-sm-5">
									<input type="text" name="effdate" id="effdate" value=""
										placeholder="DD-MM-YYYY" class="form_datetime form-control"
										readonly="readonly" />
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		$("#effdate").datetimepicker({
			...
			startDate : dateToday,
				...
				'changeDate',
				function(ev) {
					$('#expdate').datetimepicker('setStartDate',
		...
		$('#img2').change(
				function() {
					...
					var regex = new RegExp(
							"(.*?)\.(docx|doc|pdf|xml|bmp|ppt|xls|xlsx)$");
					if (!(regex.test(val))) {
						$(this).val('');
						alert('Please select correct file format');
					}
...
<script>
	...
	function onloadCustomerChatPage() {
		var chatSrc = "http://cloudchat-xangerschat.rhcloud.com/springchat/"
				+ "customerLogin";
