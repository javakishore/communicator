...
<body>
	...
	<div class="title-bar" style="    background-color:#E70028;margin: 0px;">
		...
		<h2 class="title" style="color:white">Message Status</h2>
	</div>
<!-- 	<div class="clear_both">&nbsp;</div> -->
...
<!-- 											<th>Action</th> -->
									...
									<tbody>
										<c:forEach items="${messageList}" var="messageStatus">
											<tr class="gradeA">
												<td>${messageStatus.msgID}</td>
												<td>${messageStatus.msgTitle}</td>
												<td align="left"><a href="/crmCmsAdmin/readCountMessage/${messageStatus.msgID}">${messageStatus.read}</a></td>
												<td align="left"><a href="/crmCmsAdmin/likeCountMessage/${messageStatus.msgID}">${messageStatus.likeid}</a></td>
												<td align="left"><a href="/crmCmsAdmin/favoriteCountMessage/${messageStatus.msgID}">${messageStatus.favoriteid}</a></td>
<!-- 												<td align="center"><a -->
<%-- 													href="/crmCmsAdmin/viewmessage/${message.msgID}">View</a> / <a --%>
<%-- 													href="/crmCmsAdmin/editmessage/${message.msgID}">Edit</a> / <a --%>
